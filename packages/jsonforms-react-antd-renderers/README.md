...
Install JSON Forms Core, React and React Ant Design Renderers

```bash
npm i --save @jsonforms/core @jsonforms/react @chobantonov/jsonforms-react-antd-renderers
```
